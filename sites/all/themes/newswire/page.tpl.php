<div id="main"><?php // $Id$ ?>
  ...
  <?php if (!$in_overlay): // hide in overlay ?>
    ...
    <div id="main-navigation" class="width-48-950 last nofloat clearfix">
     ...
     <?php if ($page['inner-search']): ?>
    <div id="inner_search_bg">
    	<div id="Mini-panel-searchtop">
		<?php print render($page['inner-search']); ?>  
        </div>
    </div>
     <?php endif; ?>
    <div ></div>
...
<div style="border-left:1px solid #ebebeb;border-right:1px solid #ebebeb; width:992px; margin:0 auto; padding: 0 5px;" class="clearfix">
